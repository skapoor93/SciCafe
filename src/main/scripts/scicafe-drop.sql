alter table ATTENDEDBY 
    ...
    alter table DEPARTMENT 
       drop 
       foreign key FKk045s1ouh7h4bq4s7hy24ba38;
    ...
    alter table ORGANIZATIONAL_UNIT 
       drop 
       foreign key FKdmf7b0g1nmrflixr4qw2oy5aj;
    ...
    alter table REWARDS_BY_ORGANIZATION 
       drop 
       foreign key FKc4il6u7vthwpu63padfwcb1gx;
       
    alter table REWARDS_BY_ORGANIZATION 
       drop 
       foreign key FKird5gi9ycsuce87r70oysthm3;
    ...
    alter table USER_ORGANIZATION 
       drop 
       foreign key FKpjun7upgut3l6fkc73428glpi;

    alter table USER_ORGANIZATION 
       drop 
       foreign key FKgxurdmdcnsw3ti31yitc02f61;
    ...
    drop table if exists REWARDS_BY_ORGANIZATION;
